...
var rolePermissions = map[string][]string{
	"user":  {"view_profile", "view_workouts"},
	"PT":    {"view_profile", "view_workouts", "manage_clients"},
	"admin": {"view_profile", "view_workouts", "manage_clients", "admin_dashboard", "view_all_users"},
}
