...
const (
	Auth_Register_FullMethodName       = "/fitSphere.auth.Auth/Register"
	Auth_Login_FullMethodName          = "/fitSphere.auth.Auth/Login"
	Auth_Logout_FullMethodName         = "/fitSphere.auth.Auth/Logout"
	Auth_ChangePassword_FullMethodName = "/fitSphere.auth.Auth/ChangePassword"
	Auth_ChangeEmail_FullMethodName    = "/fitSphere.auth.Auth/ChangeEmail"
	Auth_RefreshToken_FullMethodName   = "/fitSphere.auth.Auth/RefreshToken"
	Auth_GetAllUsers_FullMethodName    = "/fitSphere.auth.Auth/GetAllUsers"
	Auth_GetUserByID_FullMethodName    = "/fitSphere.auth.Auth/GetUserByID"
	Auth_DeleteUser_FullMethodName     = "/fitSphere.auth.Auth/DeleteUser"
	Auth_UpdateUser_FullMethodName     = "/fitSphere.auth.Auth/UpdateUser"
	Auth_InsertUser_FullMethodName     = "/fitSphere.auth.Auth/InsertUser"
)
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fitSphere.auth.Auth",
