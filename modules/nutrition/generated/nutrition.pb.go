...
const file_nutrition_proto_rawDesc = "" +
	"\n" +
	"\x0fnutrition.proto\x12\x13fitSphere.nutrition\x1a\x1fgoogle/protobuf/timestamp.proto\"\x14\n" +
	"\x12AnalyzeMealPlanReq\"\x14\n" +
	"\x12AnalyzeMealPlanRes\"\x15\n" +
	"\x13RecommendChangesReq\"\x15\n" +
	"\x13RecommendChangesRes2\xe2\x01\n" +
	"\x13NutritionalAnalysis\x12c\n" +
	"\x0fAnalyzeMealPlan\x12'.fitSphere.nutrition.AnalyzeMealPlanReq\x1a'.fitSphere.nutrition.AnalyzeMealPlanRes\x12f\n" +
	"\x10RecommendChanges\x12(.fitSphere.nutrition.RecommendChangesReq\x1a(.fitSphere.nutrition.RecommendChangesResb\x06proto3"
