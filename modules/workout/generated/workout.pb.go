...
type XExerciseInput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ExerciseId    string                 `protobuf:"bytes,1,opt,name=exercise_id,json=exerciseId,proto3" json:"exercise_id,omitempty"` // optional
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	ExerciseType  string                 `protobuf:"bytes,3,opt,name=exercise_type,json=exerciseType,proto3" json:"exercise_type,omitempty"`
	MuscleGroup   string                 `protobuf:"bytes,4,opt,name=muscle_group,json=muscleGroup,proto3" json:"muscle_group,omitempty"`
	Equipment     string                 `protobuf:"bytes,5,opt,name=equipment,proto3" json:"equipment,omitempty"`
	...
	Instruction   string                 `protobuf:"bytes,7,opt,name=instruction,proto3" json:"instruction,omitempty"`
	Video         string                 `protobuf:"bytes,8,opt,name=video,proto3" json:"video,omitempty"`
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // optional
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_workout_proto_rawDesc = string([]byte{
	...
	0x73, 0x65, 0x73, 0x22, 0x5d, 0x0a, 0x08, 0x58, 0x50, 0x6c, 0x61, 0x6e, 0x44, 0x61, 0x79, 0x12,
	0x10, 0x0a, 0x03, 0x64, 0x61, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x61,
	0x79, 0x12, 0x3f, 0x0a, 0x09, 0x65, 0x78, 0x65, 0x72, 0x63, 0x69, 0x73, 0x65, 0x73, 0x18, 0x02,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xbe, 0x02, 0x0a, 0x0e, 0x58, 0x45, 0x78, 0x65,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x12, 0x39, 0x0a,
