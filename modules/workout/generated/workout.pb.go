...
type DeleteWorkoutPlanReq struct {
	...
	HardDelete bool         `protobuf:"varint,2,opt,name=hard_delete,json=hardDelete,proto3" json:"hard_delete,omitempty"` // soft delete by default or change later
	Request    *BaseRequest `protobuf:"bytes,100,opt,name=request,proto3" json:"request,omitempty"`
}
...
func (x *DeleteWorkoutPlanReq) GetCustomerId() string {
	if x != nil {
		return x.CustomerId
	}
	return ""
...
var file_workout_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x88, 0x01, 0x0a, 0x14, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x57, 0x6f, 0x72,
	0x6b, 0x6f, 0x75, 0x74, 0x50, 0x6c, 0x61, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x1f, 0x0a, 0x0b, 0x63,
	...
	0x68, 0x61, 0x72, 0x64, 0x5f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
