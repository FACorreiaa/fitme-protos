...
const (
	Workout_GetExercises_FullMethodName                  = "/workout.Workout/GetExercises"
	...
	Workout_UpdateExerciseByIdWorkoutPlan_FullMethodName = "/workout.Workout/UpdateExerciseByIdWorkoutPlan"
	Workout_InsertExerciseWorkoutPlan_FullMethodName     = "/workout.Workout/InsertExerciseWorkoutPlan"
	Workout_GetWorkoutPlans_FullMethodName               = "/workout.Workout/GetWorkoutPlans"
	Workout_GetWorkoutPlan_FullMethodName                = "/workout.Workout/GetWorkoutPlan"
	Workout_DeleteWorkoutPlan_FullMethodName             = "/workout.Workout/DeleteWorkoutPlan"
	Workout_UpdateWorkoutPlan_FullMethodName             = "/workout.Workout/UpdateWorkoutPlan"
	Workout_InsertWorkoutPlan_FullMethodName             = "/workout.Workout/InsertWorkoutPlan"
)
...
func (c *workoutClient) UpdateExercice(ctx context.Context, in *UpdateExerciseReq, opts ...grpc.CallOption) (*UpdateExerciseRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func _Workout_UpdateExercice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateExerciseReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkoutServer).UpdateExercice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workout_UpdateExercice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
